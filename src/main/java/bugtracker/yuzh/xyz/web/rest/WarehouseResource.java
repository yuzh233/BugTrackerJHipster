...
/**
 * REST controller for managing {@link bugtracker.yuzh.xyz.domain.Warehouse}.
 */
@RestController
@RequestMapping("/api")
public class WarehouseResource {
    ...
    public ResponseEntity<List<WarehouseDTO>> getAllWarehouses(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
